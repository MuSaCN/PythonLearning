...
for i, row in timedf.iterrows():
    ...
    xlsxfile = reportfolder + "\\{}.{}.{}.{}.{}.{}.xlsx".format(expertfile.rsplit(sep=".", maxsplit=1)[0], symbol, tf_affix, t0, t1, t2)
...
trainmatch, testmatch = myMT5Report.read_forward_opt_csv(filepath=xlsxfile)
